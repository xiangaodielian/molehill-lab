package  
{
	...
	public class EnviorementTeapotTextureTest extends TestBase 
	{
		...
		override protected function load():void
		{
			...
			loadCubeTexture((new Right0 as Bitmap).bitmapData, 0, 0); //+X
			loadCubeTexture((new Right1 as Bitmap).bitmapData, 0, 1);
			loadCubeTexture((new Right2 as Bitmap).bitmapData, 0, 2);
			loadCubeTexture((new Right3 as Bitmap).bitmapData, 0, 3);
			loadCubeTexture((new Right4 as Bitmap).bitmapData, 0, 4);
			loadCubeTexture((new Right5 as Bitmap).bitmapData, 0, 5);
			loadCubeTexture((new Right6 as Bitmap).bitmapData, 0, 6);
			loadCubeTexture((new Right7 as Bitmap).bitmapData, 0, 7);	
			
			loadCubeTexture((new Left0 as Bitmap).bitmapData, 1, 0); //-X
			loadCubeTexture((new Left1 as Bitmap).bitmapData, 1, 1);
			loadCubeTexture((new Left2 as Bitmap).bitmapData, 1, 2);
			loadCubeTexture((new Left3 as Bitmap).bitmapData, 1, 3);
			loadCubeTexture((new Left4 as Bitmap).bitmapData, 1, 4);
			loadCubeTexture((new Left5 as Bitmap).bitmapData, 1, 5);
			loadCubeTexture((new Left6 as Bitmap).bitmapData, 1, 6);
			loadCubeTexture((new Left7 as Bitmap).bitmapData, 1, 7);	
